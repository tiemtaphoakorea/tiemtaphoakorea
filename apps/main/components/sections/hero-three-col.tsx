        ...
        <div className="grid grid-cols-[420px_1fr] gap-4">
          ...
          <aside className="flex flex-col overflow-hidden rounded-2xl border border-border bg-white p-2">
            ...
            {topProducts.map((p, idx) => (
              ...
              >
                <span className="relative grid h-10 w-10 shrink-0 place-items-center overflow-hidden rounded-lg bg-secondary">
                  {p.thumbnail && (
                    <Image
                      src={p.thumbnail}
                      alt={p.name}
                  ...
                  <span className="absolute -left-1 -top-1 grid h-4 w-4 place-items-center rounded-full bg-primary text-[9px] font-bold text-white">
                    {idx + 1}
                  </span>
                </span>
