  ...
  return (
    <div className="grid grid-cols-1 gap-8 py-6 lg:grid-cols-2">
      <div>
        ...
        <div className="mt-3.5 rounded-xl bg-secondary/60 p-4 text-xs leading-relaxed text-muted-foreground">
          <b className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-foreground">
            Cam kết
          </b>
          ...
          <tbody>
            {specs.map(([k, v]) => (
              <tr key={k} className="border-b border-border last:border-b-0">
                <td className="w-35 py-2.5 font-medium text-muted-foreground">{k}</td>
