            ...
            <ShowcaseBox title="status-colors — applied via Tailwind utilities" className="mb-8">
              ...
              <div className="mt-4 grid grid-cols-2 gap-1 sm:grid-cols-3">
                {statusColors.map((s) => (
                  ...
                  >
                    bg-{s.name.toLowerCase()}-50 / text-{s.name.toLowerCase()}
                    -600
                  </code>
                ))}
              </div>
              ...
              <div className="flex flex-wrap items-end gap-4">
                {radiusTokens.map((r) => (
                  <div key={r.tailwind} className="flex flex-col items-center gap-2">
                    <div
                      className={`size-14 border-2 border-primary bg-primary/10 ${r.tailwind}`}
                    />
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <div className="flex flex-col items-center gap-1.5">
                    <Avatar className="size-12">
                      <AvatarImage
                        src="https://api.dicebear.com/9.x/initials/svg?seed=KH"
                        alt="KH"
                      />
              ...
              <ShowcaseBox title="command-description">
                <div className="space-y-3">
                  <p className="text-sm text-slate-700">
                    ...
                    provide a fully accessible command palette with fuzzy search, keyboard
                    navigation, and group organization.
                  </p>
                  <div className="space-y-1.5">
                    {[
                  ...
                  <Sheet key={side}>
                    ...
                    <SheetContent side={side}>
                      <SheetHeader>
                        ...
                        <SheetDescription>
                          This sheet slides in from the {side}. Use for navigation, filters, or
                          detail panels.
                        </SheetDescription>
                      </SheetHeader>
                      <div className="py-6">
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-900 p-8 text-white">
                ...
                <div className="mt-6 flex items-center gap-2 rounded-lg border border-slate-700 bg-white/5 px-4 py-3">
                  ...
                  <p className="text-sm text-slate-300">
                    Dark mode: add{" "}
                    <code className="rounded bg-white/10 px-1.5 font-mono text-xs">.dark</code>{" "}
                    class to{" "}
