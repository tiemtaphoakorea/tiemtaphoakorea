      ...
      <CardContent className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col leading-tight">
            <span className="text-sm font-semibold">Bộ tạo biến thể tự động</span>
        ...
        <Table>
          <TableHeader className="sticky top-0 z-10">
            <TableRow className="bg-muted/40 hover:bg-muted/40">
              {[
                { label: "", width: "w-10" },
                { label: "Tên biến thể", width: "min-w-37" },
                { label: "SKU", width: "min-w-30" },
                ...
                <TableHead
                  key={i}
                  className={`px-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground ${h.width}`}
                >
                  {h.label}
                </TableHead>
              ))}
