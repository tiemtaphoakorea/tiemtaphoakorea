          ...
          <CardContent className="p-0">
            {isLoading ? (
              ...
              <>
                ...
                <div className="flex flex-col items-stretch gap-3 border-t border-slate-100 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 dark:border-slate-800">
