...
import { USER_ROLE_CONFIG, USER_STATUS_CONFIG } from "@repo/shared/constants";
      ...
      <AlertDialog open={!!deletingUser} onOpenChange={(open) => !open && setDeletingUser(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Bạn có chắc muốn xóa nhân viên <strong>{deletingUser?.fullName}</strong>? Hành động
