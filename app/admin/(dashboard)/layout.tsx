...
import { ADMIN_ROUTE_NAMES, ADMIN_TITLE } from "@/lib/constants";
import { getBreadcrumbName } from "@/lib/utils";
  ...
  if (isError || !user) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4">
        <p className="text-destructive">Unauthorized or Failed to load profile.</p>
        <button
