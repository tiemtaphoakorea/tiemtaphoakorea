...
interface SupplierOrderToolbarProps {
  searchTerm: string;
...
export function SupplierOrderToolbar({
  searchTerm,
  onSearchChange,
  statusFilter,
  onStatusChange,
  statusConfig,
}: SupplierOrderToolbarProps) {
  return (
      ...
      <div className="flex items-center gap-3">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="outline"
              className="h-10 gap-2 border-slate-200 font-bold dark:border-slate-800"
            >
