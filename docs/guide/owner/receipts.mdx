...
| **Đã thanh toán** | Đã trả đủ — điều kiện để hoàn tất phiếu |
...
<Steps>
  ...
  <Step title="Chiết khấu và phí phát sinh">
    Có thể nhập chiết khấu tổng hoặc phí phát sinh (vận chuyển, bốc dỡ...) ở phần dưới.
    Hệ thống hiển thị **Phải trả NCC** theo thời gian thực.
  </Step>
...
<Steps>
  ...
  <Step title="Xác nhận">
    Nhấn **Xác nhận**. Phiếu chi NCC được tạo, số **Đã trả** cập nhật ngay.
  </Step>
</Steps>

Có thể thanh toán nhiều lần (từng phần) cho đến khi đủ. Mỗi lần tạo một phiếu chi riêng.

### Xoá phiếu chi

Khi phiếu nhập còn ở **Đang giao dịch**, có thể xoá từng phiếu chi bằng icon 🗑 trên dòng tương ứng để điều chỉnh lại.

## Hoàn tất phiếu nhập

<Warning>
Phải **thanh toán đủ** (Còn phải trả = 0đ) trước khi hoàn tất. Nút **Hoàn tất** bị khoá khi còn nợ.
</Warning>
...
<Steps>
  ...
  <Step title="Nhấn Hoàn tất">
    Xác nhận trong dialog. Hệ thống tự động:
    - Cộng số lượng vào **Tồn vật lý** (`onHand`) của từng biến thể
    - Tính lại **Giá vốn bình quân** (WAC)
    - Cập nhật trạng thái đơn đặt hàng liên kết (nếu có)
  </Step>
</Steps>
...
Tab **Tất cả / Đang giao dịch / Hoàn thành** · Tìm kiếm theo mã phiếu, NCC · Lọc theo NCC · Lọc theo trạng thái thanh toán.
