...
flowchart LR
    ...
    B -->|Tạo phiếu nhập + Hoàn tất| C["Đã nhận<br/>received"]
    A & B -->|Huỷ đơn| D["Đã huỷ<br/>cancelled"]
...
| **Đã nhận** | Ít nhất một phiếu nhập đã hoàn tất |
| **Đã huỷ** | Đơn bị huỷ |
...
Khi đơn ở trạng thái **Đã đặt**, nút **Tạo phiếu nhập** xuất hiện. Hệ thống tự điền NCC, sản phẩm và giá nhập từ đơn vào phiếu.

<Steps>
  <Step title="Mở chi tiết đơn đã xác nhận">
    Đơn phải ở trạng thái **Đã đặt**.
  </Step>
...
<Warning>
Chỉ huỷ được đơn ở trạng thái **Nháp** hoặc **Đã đặt**. Đơn đã **Đã nhận** không thể huỷ.
</Warning>
