...
<Steps>
  ...
  <Step title="Huỷ đơn">
    Chỉ đơn `pending` có thể huỷ trên luồng hiện tại. Nhấn **Huỷ đơn** → nhập ghi chú → xác nhận. Hệ thống giải phóng số đang giữ chỗ (`reserved`); `onHand` không đổi vì đơn chưa xuất kho.
  </Step>
