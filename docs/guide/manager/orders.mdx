...
Các trạng thái `preparing` và `shipping` có thể xuất hiện trên những đơn hàng được xử lý qua các luồng khác. Khi gặp đơn ở những trạng thái này, bạn có thể đánh dấu đã giao hoặc hủy (chỉ `preparing`).
