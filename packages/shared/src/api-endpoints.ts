...
export const API_ENDPOINTS = {
  ADMIN: {
    ...
    INVENTORY: {
      ...
      OPENING_STOCK_LIST: "/api/admin/inventory/opening-stock/list",
      OPENING_STOCK_BULK: "/api/admin/inventory/opening-stock/bulk",
      OPENING_STOCK_PREVIEW: "/api/admin/inventory/opening-stock/import/preview",
    },
    PURCHASES: "/api/admin/purchases",
    PURCHASE_DETAIL: (id: string) => `/api/admin/purchases/${id}`,
    PURCHASE_CONFIRM: (id: string) => `/api/admin/purchases/${id}/confirm`,
    PURCHASE_CANCEL: (id: string) => `/api/admin/purchases/${id}/cancel`,
    RECEIPTS: "/api/admin/receipts",
    RECEIPT_DETAIL: (id: string) => `/api/admin/receipts/${id}`,
    RECEIPT_COMPLETE: (id: string) => `/api/admin/receipts/${id}/complete`,
    RECEIPT_CANCEL: (id: string) => `/api/admin/receipts/${id}/cancel`,
    PAYOUTS: "/api/admin/payouts",
    PAYOUT_DETAIL: (id: string) => `/api/admin/payouts/${id}`,
    INVENTORY_VALUATION: "/api/admin/analytics/inventory-valuation",
    INVENTORY_FLOW: "/api/admin/analytics/inventory/flow",
    SUPPLIER_DEBTS: "/api/admin/analytics/supplier-debts",
  },
  CHAT: {
    SEND: "/api/chat",
    UPLOAD: "/api/chat",
