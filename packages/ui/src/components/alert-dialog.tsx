...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 mt-2 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t border-border px-4 pt-3 pb-4 group-data-[size=sm]/alert-dialog-content:grid group-data-[size=sm]/alert-dialog-content:grid-cols-2 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    />
