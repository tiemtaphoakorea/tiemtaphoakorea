...
function getColumnId<TData, TValue>(column: FlatColumn<TData, TValue>, index: number) {
  if (column.id) {
    return column.id;
  }
...
function getCellValue<TData, TValue>(column: FlatColumn<TData, TValue>, row: TData, index: number) {
                ...
                const row = {
                  ...
                  getValue: (columnId: string) => {
                    const column = flatColumns.find(
                      (candidate, index) => getColumnId(candidate, index) === columnId,
                    );
                    return column ? getCellValue(column, item, rowIndex) : undefined;
                  },
                };
